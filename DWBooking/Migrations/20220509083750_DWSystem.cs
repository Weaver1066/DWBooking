...
{
    public partial class DWSystem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CouncelingID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Councelings", x => x.CouncelingID);
                    table.ForeignKey(
                        name: "FK_Councelings_Clients_ClientID",
                        column: x => x.ClientID,
                        principalTable: "Clients",
                        principalColumn: "ClientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Councelings_Employees_EmployeeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Councelings_ClientID",
                table: "Councelings",
                column: "ClientID");

            migrationBuilder.CreateIndex(
                name: "IX_Councelings_EmployeeID",
                table: "Councelings",
                column: "EmployeeID");
